...
export default function BeautyByTheBeast() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-lime-50">
      ...
      <div className="bg-gradient-to-r from-green-700 via-green-600 to-green-700 text-white py-3 px-4">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
          <span className="font-bold">🌿 Commercial & Residential Lawn Care • Dunedin, FL</span>
          <a href="tel:7273662361" className="font-bold hover:text-green-100">☎️ (727) 366-2361</a>
        </div>
      </div>
      ...
      <header className="bg-white shadow-lg py-10 px-4 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <p className="text-2xl text-gray-700 font-bold">Professional Lawn Care & Landscaping</p>
        </div>
      </header>
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-green-700 via-green-600 to-lime-600 text-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          <h3 className="text-5xl sm:text-6xl font-black mb-20">
            Why Choose Beauty by the Beast? 💪
          </h3>
      ...
      <section className="py-24 px-4 bg-gradient-to-b from-white to-green-50">
        <div className="max-w-5xl mx-auto text-center">
          <h3 className="text-5xl font-black text-gray-900 mb-6">
            Serving <span className="text-green-600">Dunedin</span> & Surrounding Areas
          </h3>
            ...
            <div className="space-y-10">
              <div>
                ...
                <p className="text-2xl text-gray-700 leading-relaxed font-semibold">
                  Contact Beauty by the Beast today for professional lawn care and landscaping services in Dunedin, FL.
                </p>
              </div>
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div className="ml-8">
                    ...
                    <a href="tel:7273662361" className="text-green-600 hover:text-green-700 font-black text-4xl">(727) 366-2361</a>
                  </div>
                </div>
      ...
      <footer className="bg-gray-900 text-gray-300 py-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-2xl text-gray-400 mb-8 font-bold">Professional Lawn Care & Landscaping</p>
          <div className="space-y-3 mb-10">
            <p className="text-green-400 font-black text-2xl">(727) 366-2361</p>
            <p className="text-xl">2045 Summit Drive, Dunedin, FL 34698</p>
            <p className="text-green-400 font-bold text-lg">Commercial & Residential Services</p>
          </div>
          <div className="pt-10 border-t border-gray-800">
            <p className="text-sm text-gray-500">© 2025 Beauty by the Beast LLC. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
