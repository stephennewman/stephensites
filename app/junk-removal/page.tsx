    ...
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-amber-50">
      ...
      <div className="bg-gradient-to-r from-orange-600 via-amber-600 to-orange-600 text-white py-3 px-4">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
          ...
          <a href="tel:5551234567" className="font-bold hover:text-orange-100">☎️ (555) 123-4567</a>
        </div>
      </div>
      ...
      <header className="bg-white shadow-lg py-10 px-4 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <p className="text-2xl text-gray-700 font-bold">Fast & Reliable Hauling Services in Palm Harbor</p>
        </div>
      </header>
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-orange-600 via-amber-600 to-orange-700 text-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-10">
            {[
              { num: '1', icon: '📞', title: 'Call Us', desc: 'Contact us at (555) 123-4567 anytime—24 hours!' },
            ...
            <div className="space-y-10">
              <div>
                ...
                <p className="text-2xl text-gray-700 leading-relaxed font-semibold">
                  Contact us today for professional junk removal in Palm Harbor. Available 24 hours for your convenience!
                </p>
              </div>
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div className="ml-8">
                    ...
                    <a href="tel:5551234567" className="text-orange-600 hover:text-orange-700 font-black text-4xl">(555) 123-4567</a>
                  </div>
                </div>
      ...
      <footer className="bg-gray-900 text-gray-300 py-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-2xl text-gray-400 mb-8 font-bold">Fast & Reliable Hauling Services</p>
          <div className="space-y-3 mb-10">
            <p className="text-orange-400 font-black text-2xl">(555) 123-4567</p>
          ...
          <div className="pt-10 border-t border-gray-800">
            <p className="text-sm text-gray-500">© 2025 Professional Junk Removal. All rights reserved. • Serving Palm Harbor & Tampa Bay Area</p>
          </div>
        </div>
      </footer>
    </div>
