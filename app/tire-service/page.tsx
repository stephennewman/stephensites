    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-red-600 text-white py-2 px-4">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="tel:5551234567" className="font-bold hover:underline">📞 (555) 123-4567</a>
          </div>
        </div>
      </div>
      ...
      <header className="bg-gray-900 text-white py-6 px-4 shadow-lg">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl sm:text-4xl font-bold text-center">Professional Tire & Automotive</h1>
      ...
      <section className="relative bg-gradient-to-r from-gray-800 to-gray-700 text-white py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-3xl mx-auto">
            Professional service from our expert team. We treat you like family—honest work, fair prices, and quality you can trust.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="tel:5551234567" className="bg-red-600 hover:bg-red-700 px-10 py-4 rounded-lg font-bold text-lg transition-colors shadow-lg">
              Call (555) 123-4567
            </a>
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-red-50 to-gray-50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {[
              { icon: '👨‍👩‍👧‍👦', title: 'Family-Owned', desc: '10+ years serving Palm Harbor families' },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { name: 'Mary Marsh', text: 'People pleasant, work done quickly & price was reasonable.', platform: 'Google' },
              { name: 'Patrick Nolan', text: 'This is a good place family-owned and staff will help you out.', platform: 'Google' }
            ].map((review, i) => (
      ...
      <section id="location" className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <h3 className="text-4xl font-bold text-center mb-12 text-gray-900">Visit Us in Palm Harbor</h3>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-700 text-lg mt-1">Palm Harbor, FL<br/>& Surrounding Areas</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <a href="tel:5551234567" className="text-red-600 hover:underline text-lg mt-1 block">(555) 123-4567</a>
                </div>
              </div>
              ...
              <div className="pt-6">
                <a 
                  href="https://www.google.com/maps/place/Palm+Harbor,+FL"
                  target="_blank"
      ...
      <footer className="bg-gray-900 text-white py-12 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-2">Professional Tire & Automotive</h2>
          <p className="text-gray-400 mb-4 text-lg">Your trusted family-owned auto shop in Palm Harbor, FL</p>
          <div className="flex justify-center gap-8 mb-6 text-sm">
            <a href="tel:5551234567" className="hover:text-red-500 transition-colors">(555) 123-4567</a>
            <span className="text-gray-600">|</span>
            <span>Palm Harbor, FL & Surrounding Areas</span>
          </div>
          <p className="text-sm text-gray-500">© 2025 Professional Tire & Automotive. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
