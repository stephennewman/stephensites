    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="bg-gradient-to-r from-orange-600 via-red-600 to-orange-600 py-1">
        <div className="bg-gradient-to-r from-gray-900 via-black to-gray-900 py-3 px-4 border-y border-orange-500">
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <a href="tel:5551234567" className="font-bold text-orange-400 hover:text-orange-300">☎️ (555) 123-4567</a>
          </div>
        </div>
      </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { name: 'John D.', text: 'They genuinely care about people and are trustworthy.', rating: 5 },
              { name: 'Sarah M.', text: "This is hands down the BEST shop I've ever been to.", rating: 5 },
              { name: 'Mike T.', text: 'Very honest and knows how to fix all types of cars.', rating: 5 }
            ].map((review, i) => (
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-xl text-gray-400 leading-relaxed font-bold">
                  Visit us in Palm Harbor. Open 7 days a week with experienced mechanics ready to serve you.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-6">
                    ...
                    <a href="tel:5551234567" className="text-white hover:text-orange-500 font-black text-3xl">(555) 123-4567</a>
                  </div>
                </div>
      ...
      <footer className="bg-black text-gray-400 py-12 px-4 border-t-4 border-orange-600">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="space-y-2 mb-8">
            <p className="text-orange-500 font-black text-xl">(555) 123-4567</p>
            <p className="font-bold">Palm Harbor, FL & Surrounding Areas</p>
          ...
          <div className="pt-8 border-t border-gray-800">
            <p className="text-sm text-gray-600 uppercase tracking-wider">© 2025 Professional Auto Repair LLC. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
