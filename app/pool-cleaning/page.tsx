    ...
    <div className="min-h-screen bg-gradient-to-b from-cyan-50 to-blue-50">
      ...
      <div className="bg-gradient-to-r from-cyan-500 via-blue-500 to-cyan-500 text-white py-3 px-4">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
          ...
          <a href="tel:5551234567" className="font-bold hover:text-cyan-100">☎️ (555) 123-4567</a>
        </div>
      </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { name: 'Sarah M.', text: 'They transformed our pool! The automation system they installed lets me control everything from my phone. Professional and reliable.', stars: 5 },
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Contact us today for a free quote. Licensed, insured, and ready to serve Palm Harbor and surrounding areas.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-6">
                    ...
                    <a href="tel:5551234567" className="text-cyan-600 hover:text-cyan-700 font-bold text-3xl">(555) 123-4567</a>
                  </div>
                </div>
      ...
      <footer className="bg-gray-900 text-gray-300 py-12 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="space-y-2 mb-8">
            <p className="text-cyan-400 font-bold text-xl">(555) 123-4567</p>
            <p>Palm Harbor, FL & Surrounding Areas</p>
          ...
          <div className="pt-8 border-t border-gray-800">
            <p className="text-sm text-gray-500">© 2025 Professional Pool Services LLC. All rights reserved. • Licensed & Insured</p>
          </div>
        </div>
      </footer>
    </div>
