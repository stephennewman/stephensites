    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <header className="bg-blue-900 text-white py-4 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold">Professional Quick Lube</h1>
            <p className="text-blue-200 text-sm mt-1">Fast, Honest, Local</p>
          </div>
          <a href="tel:5551234567" className="bg-orange-500 hover:bg-orange-600 px-4 py-2 sm:px-6 sm:py-3 rounded-lg font-semibold text-sm sm:text-base transition-colors">
            Call Now
          </a>
        </div>
      </header>
      ...
      <section className="bg-gradient-to-r from-blue-800 to-blue-900 text-white py-16 sm:py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="tel:5551234567" className="bg-white text-blue-900 hover:bg-gray-100 px-8 py-4 rounded-lg font-bold text-lg transition-colors">
              (555) 123-4567
            </a>
          </div>
        </div>
      ...
      <section className="bg-gray-50 py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { name: 'Michael Wick', text: "This place is quick, reasonable and knowledgeable. I have a 2015 GMC 2500 Duramax diesel and it's not a problem. Conveniently located in Palm Harbor", time: '2 months ago' },
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Palm Harbor, FL<br/>& Surrounding Areas</p>
                </div>
              </div>
              <div className="flex items-start">
                <span className="text-2xl mr-4">📞</span>
                <div>
                  ...
                  <a href="tel:5551234567" className="text-blue-600 hover:underline">(555) 123-4567</a>
                </div>
              </div>
              <div className="flex items-start">
                <span className="text-2xl mr-4">🕐</span>
      ...
      <footer className="bg-blue-900 text-white py-8 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-2xl font-bold mb-2">Professional Quick Lube</h2>
          <p className="text-blue-200 mb-4">Your trusted local oil change service since day one</p>
          <p className="text-sm text-blue-300">© 2025 Professional Quick Lube. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
